    ...
    async execute(interaction) {
        ...
        const embedSetup = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: "Winrate", value: String(response.data.highestPick_Winrate?.[0].toFixed(2) + "%"), inline: true },
                    { name: '\u200B', value: String(response.data.highestPick_Winrate?.[1].toFixed(2) + "%"), inline: true },
                    { name: '\u200B', value: String(response.data.highestPick_Winrate?.[2].toFixed(2) + "%"), inline: true },
                    { name: '\u200B', value: '\u200B' },
